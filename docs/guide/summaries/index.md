...
![Tales tab showing a generated session summary with Generate Summary, Generate POV Summaries, and Clear All buttons, followed by the full narrative recap with Edit, Regenerate, and Delete options](../images/tales-tab.png)
