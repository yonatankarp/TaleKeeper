# Session Illustrations Tab

## Purpose

Provide a Visions tab in the session detail view for generating, viewing, editing prompts for, and managing AI-generated session illustrations.
