...
Generate narrative session summaries and per-player POV summaries using the configured LLM provider, with support for model configuration, long transcript chunking, summary regeneration, editing, and metadata tracking.
