...
Generate narrative session summaries and per-player POV summaries using a local LLM via Ollama, with support for model configuration, long transcript chunking, summary regeneration, editing, and metadata tracking.
